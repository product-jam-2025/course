...
- flexbox layout with header, footer and content
-
...
- Use JavaScript to create a simple interaction
  ...
  clicking a button, when hovering over and element, or on any event that you
  wish. Animate the change of class using CSS transitions.
